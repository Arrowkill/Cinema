...
export default function Home(initialData) {
  ...
  useEffect(()=>{
    setSearchResults(initialData.upcomingMovies.results)
  }, [initialData])
...
export async function getServerSideProps() {
  let upcomingMovies = await fetch(`https://api.themoviedb.org/3/movie/now_playing?api_key=${serverRuntimeConfig.apiKey}&language=en-US&page=1&region=US`)
  upcomingMovies = await upcomingMovies.json()
  console.log(upcomingMovies)
  return {props: {upcomingMovies: upcomingMovies}}
}